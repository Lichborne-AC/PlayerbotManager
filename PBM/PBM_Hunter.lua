...
function PBM.OpenHunterMenu(row)
    if not LichborneHunterMenu then
        ...
        local treeBmBtn = MakeTreeBtn(col1X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Uses |cffABD473Kill Command, Steady Shot,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Arcane Shot|r, and |cffABD473Multi-Shot|r (|cffffcc00AoE|r).", 1, 1, 1)
            GameTooltip:AddLine("Empowers the |cffffcc00pet|r in combat.", 1, 1, 1)
        ...
        local treeMmBtn = MakeTreeBtn(col2X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Uses |cffABD473Aimed Shot, Steady Shot,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Chimera Shot|r, and |cffABD473Arcane Shot|r.", 1, 1, 1)
        ...
        local treeSurvBtn = MakeTreeBtn(col3X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Uses |cffABD473Explosive Shot, Steady Shot,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Black Arrow|r, and |cffABD473Serpent Sting|r.", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00Lock and Load|r (|cffffcc00proc|r) triggers burst.", 1, 1, 1)
            GameTooltip:AddLine("Maintains |cffffcc00DoTs|r on target.", 1, 1, 1)
        ...
        local treeTrapWeaveBtn = MakeTreeBtn(combatHdrX + 60, combatIconY,
            ...
            GameTooltip:AddLine("Closes to melee to drop", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Immolation Trap|r under the target.", 1, 1, 1)
            GameTooltip:AddLine("Suppresses |cffABD473Disengage|r and", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Black Arrow|r while active.", 1, 1, 1)
        end)
        ...
        local treeTankAssistBtn = MakeTreeBtn(combatHdrX, assistIconY,
            ...
            GameTooltip:AddLine("|cffABD473Misdirection|r sent to the", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00tank|r on cooldown.", 1, 1, 1)
        end)
        ...
        local treeDpsAoeBtn = MakeTreeBtn(combatHdrX + 60, assistIconY,
            ...
            GameTooltip:AddLine("Uses |cffABD473Multi-Shot, Volley,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffABD473Explosive Trap|r on |cffffcc00AoE|r targets.", 1, 1, 1)
        end)
