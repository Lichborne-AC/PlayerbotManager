...
local DK_TALENT_SPECS = {
    { label=PBM_L["Blood |cffffcc00PvE|r"],       spec="blood pve",            wowSpec="Blood",    icon="Interface\\Icons\\Spell_DeathKnight_BloodPresence"  },
    { label=PBM_L["Frost |cffffcc00PvE|r"],       spec="frost pve",            wowSpec="Frost DK", icon="Interface\\Icons\\Spell_DeathKnight_FrostPresence"  },
    { label=PBM_L["Unholy |cffffcc00PvE|r"],      spec="unholy pve",           wowSpec="Unholy",   icon="Interface\\Icons\\Spell_DeathKnight_UnholyPresence" },
    { label=PBM_L["Double Aura Blood |cffffcc00PvE|r"], spec="double aura blood pve", wowSpec="Blood", icon="Interface\\Icons\\Spell_DeathKnight_BloodPresence"  },
    { label=PBM_L["Blood |cffff4444PvP|r"],       spec="blood pvp",            wowSpec="Blood",    icon="Interface\\Icons\\Spell_DeathKnight_BloodPresence"  },
    { label=PBM_L["Frost |cffff4444PvP|r"],       spec="frost pvp",            wowSpec="Frost DK", icon="Interface\\Icons\\Spell_DeathKnight_FrostPresence"  },
    { label=PBM_L["Unholy |cffff4444PvP|r"],      spec="unholy pvp",           wowSpec="Unholy",   icon="Interface\\Icons\\Spell_DeathKnight_UnholyPresence" },
}
...
function PBM.OpenDKMenu(row)
    if not LichborneDKMenu then
        ...
        bloodSpecLabel:SetText(PBM_L["Blood"])
        ...
        treeBloodBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Blood"] .. "|r |cff999999- |r|cffC41F3Bblood|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Blood tank specialization"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Frost, Unholy."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeFrostBtn:SetScript("OnEnter", function(self)
            GameTooltip:SetOwner(self, "ANCHOR_TOP")
            GameTooltip:SetFrameLevel(LichborneDKMenu:GetFrameLevel() + 20)
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Frost"] .. "|r |cff999999- |r|cffC41F3Bfrost|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Frost DPS specialization"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Blood, Unholy."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        unholySpecLabel:SetText(PBM_L["Unholy"])
        ...
        treeUnholyBtn:SetScript("OnEnter", function(self)
            GameTooltip:SetOwner(self, "ANCHOR_TOP")
            GameTooltip:SetFrameLevel(LichborneDKMenu:GetFrameLevel() + 20)
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Unholy"] .. "|r |cff999999- |r|cffC41F3Bunholy|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Unholy DPS specialization"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Blood, Frost."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeAoeFrostBtn:SetScript("OnEnter", function(self)
            GameTooltip:SetOwner(self, "ANCHOR_TOP")
            GameTooltip:SetFrameLevel(LichborneDKMenu:GetFrameLevel() + 20)
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Frost AoE"] .. "|r |cff999999- |r|cffC41F3Bfrost aoe|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Frost AoE rotation"] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeAoeUnholyBtn:SetScript("OnEnter", function(self)
            GameTooltip:SetOwner(self, "ANCHOR_TOP")
            GameTooltip:SetFrameLevel(LichborneDKMenu:GetFrameLevel() + 20)
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Unholy AoE"] .. "|r |cff999999- |r|cffC41F3Bunholy aoe|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Unholy AoE rotation"] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsAssistBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine(PBM_L["Bot focuses DPS on the DPS assist target."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsAoeBtn:SetScript("OnEnter", function(self)
            GameTooltip:SetOwner(self, "ANCHOR_TOP")
            GameTooltip:SetFrameLevel(LichborneDKMenu:GetFrameLevel() + 20)
            GameTooltip:SetText("|cffffcc00" .. PBM_L["DPS AoE"] .. "|r |cff999999- |r|cffff8000dps aoe|r |cffffcc00CO|r")
