...
local MAGE_TALENT_SPECS = {
    { label=PBM_L["Arcane"] .. " |cffffcc00PvE|r",    spec="arcane pve",   wowSpec="Arcane", icon="Interface\\Icons\\Spell_Holy_MagicalSentry"     },
    { label=PBM_L["Fire"] .. " |cffffcc00PvE|r",      spec="fire pve",     wowSpec="Fire",   icon="Interface\\Icons\\Spell_Fire_FireBolt02"        },
    { label=PBM_L["Frost"] .. " |cffffcc00PvE|r",     spec="frost pve",    wowSpec="Frost",  icon="Interface\\Icons\\Spell_Frost_FrostBolt02"      },
    { label=PBM_L["Frostfire"] .. " |cffffcc00PvE|r", spec="frostfire pve",wowSpec="Fire",   icon="Interface\\Icons\\Ability_Mage_FrostFireBolt"   },
    { label=PBM_L["Arcane"] .. " |cffff4444PvP|r",    spec="arcane pvp",   wowSpec="Arcane", icon="Interface\\Icons\\Spell_Holy_MagicalSentry"     },
    { label=PBM_L["Fire"] .. " |cffff4444PvP|r",      spec="fire pvp",     wowSpec="Fire",   icon="Interface\\Icons\\Spell_Fire_FireBolt02"        },
    { label=PBM_L["Frost"] .. " |cffff4444PvP|r",     spec="frost pvp",    wowSpec="Frost",  icon="Interface\\Icons\\Spell_Frost_FrostBolt02"      },
}
...
function PBM.OpenMageMenu(row)
    if not LichborneMageMenu then
        ...
        arcaneSpecLabel:SetText(PBM_L["Arcane"])
        ...
        treeArcaneBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Arcane"] .. "|r |cff999999- |r|cff69CCF0arcane|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Arcane mage DPS"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Fire, Frost, Frostfire."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        fireSpecLabel:SetText(PBM_L["Fire"])
        ...
        treeFireBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Fire"] .. "|r |cff999999- |r|cff69CCF0fire|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Fire mage DPS"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Arcane, Frost, Frostfire."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        frostSpecLabel:SetText(PBM_L["Frost"])
        ...
        treeFrostBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Frost"] .. "|r |cff999999- |r|cff69CCF0frost|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Frost mage DPS"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Arcane, Fire, Frostfire."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        frostfireSpecLabel:SetText(PBM_L["Frostfire"])
        ...
        treeFrostFireBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Frostfire"] .. "|r |cff999999- |r|cff69CCF0frostfire|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Frostfire mage DPS"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFF4444" .. PBM_L["Mutually exclusive with Arcane, Fire, Frost."] .. "|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        aoeSpecLabel:SetText(PBM_L["AoE"])
        ...
        treeAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["AoE"] .. "|r |cff999999- |r|cff69CCF0aoe|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["AoE rotation modifier"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Spec-aware — adapts to the active talent tree."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        firestarterSpecLabel:SetText(PBM_L["Firestarter"])
        ...
        treeFirestarterBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Firestarter"] .. "|r |cff999999- |r|cff69CCF0firestarter|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Melee range opener"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Runs to melee range to use |cff5599EEDragon's Breath|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["and |cff5599EEBlast Wave|r as openers."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        buffsSpecLabel:SetText(PBM_L["Buffs (Self)"])
        ...
        treeMageArmorBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Mage Armor"] .. "|r |cff999999- |r|cffffff00bmana|r |cffff8000NC|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Mana regen armor"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Increases |cff1EFF00resistance|r to magic debuffs."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cff3A8FC4Mana|r regeneration continues while casting."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Best for survivability and mana-intensive fights."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Molten Armor.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeMoltenArmorBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Molten Armor"] .. "|r |cff999999- |r|cffffff00bdps|r |cffff8000NC|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Crit DPS armor"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Causes |cffFF4444fire damage|r when hit."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Increases |cffFF9900crit chance|r by your |cff1EFF00Spirit|r."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Best for pure DPS output."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Mage Armor.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        assistSpecLabel:SetText(PBM_L["Assist"])
        ...
        treeDpsAssistBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine(PBM_L["Bot attacks the main DPS focus target."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["DPS AoE"] .. "|r |cff999999- |r|cff69CCF0aoe|r |cffee4433CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Cross-role AoE mode"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Bot switches to |cffffcc00AoE|r rotation."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        buffSideHdrLabel:SetText(PBM_L["Buff"])
        ...
        treeSideBuffBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["Buff"] .. "|r |cff999999- |r|cffffff00buff|r |cffff8000NC|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Group Intellect buff"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cff5599EEArcane Intellect|r on all party members."], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Increases |cffffcc00Intellect|r for 30 min."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeCCBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichborneMageMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText("|cffffcc00" .. PBM_L["CC"] .. "|r |cff999999- |r|cffff8000cc|r |cffffcc00CO|r")
            GameTooltip:AddLine("|cffffcc00" .. PBM_L["Crowd control"] .. "|r", 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Sheeps (|cff5599EEPolymorph|r) extra targets in combat."], 1, 1, 1)
