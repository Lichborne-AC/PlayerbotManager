...
function PBM.OpenMageMenu(row)
    if not LichborneMageMenu then
        ...
        treeArcaneTex:SetTexture("Interface\\Icons\\Ability_Mage_ArcaneBarrage")
        ...
        treeArcaneBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cff5599EEArcane Blast|r stacks, |cff5599EEArcane Missiles,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEArcane Barrage, Arcane Power, Mirror Image.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00AoE:|r |cff5599EEFlamestrike, Blizzard, Arcane Explosion.|r", 1, 1, 1)
        ...
        treeFireTex:SetTexture("Interface\\Icons\\Spell_Fire_FireBall02")
        ...
        treeFireBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cff5599EEFireball, Scorch|r stacks, |cff5599EEFire Blast,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEPyroblast|r (|cffffcc00Hot Streak|r), |cff5599EELiving Bomb, Combustion.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00AoE:|r |cff5599EEDragon's Breath, Blast Wave,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEFlamestrike, Blizzard, Living Bomb|r spread.", 1, 1, 1)
        ...
        treeFrostBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cff5599EEFrostbolt, Ice Lance|r (procs),", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEDeep Freeze, Frostfire Bolt|r (|cffffcc00Brain Freeze|r),", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEIce Barrier, Cold Snap, Water Elemental.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00AoE:|r |cff5599EEFlamestrike, Blizzard, Cone of Cold.|r", 1, 1, 1)
        ...
        treeFrostFireBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cff5599EEFrostfire Bolt|r — |cffffcc00Fire|r tree hybrid rotation.", 1, 1, 1)
            GameTooltip:AddLine("Benefits from both |cffffcc00Frost|r and |cffffcc00Fire|r talents.", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00AoE:|r |cff5599EEDragon's Breath, Blast Wave,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEFlamestrike, Blizzard, Living Bomb|r spread.", 1, 1, 1)
        ...
        treeAoeTex:SetTexture("Interface\\Icons\\Spell_Shadow_RainOfFire")
        ...
        treeAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffffcc00Arcane:|r |cff5599EEFlamestrike, Blizzard,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEArcane Explosion.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00Frost:|r |cff5599EEFlamestrike, Blizzard,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EECone of Cold.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00Fire / Frostfire:|r |cff5599EEDragon's Breath,|r", 1, 1, 1)
            GameTooltip:AddLine("|cff5599EEBlast Wave, Flamestrike, Blizzard.|r", 1, 1, 1)
            GameTooltip:Show()
        end)
