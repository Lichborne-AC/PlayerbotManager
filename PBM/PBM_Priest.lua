...
local PRIEST_TALENT_SPECS = {
    { label=PBM_L["Discipline |cffffcc00PvE|r"], spec="disc pve",   wowSpec="Discipline",  icon="Interface\\Icons\\Spell_Holy_WordFortitude"    },
    { label=PBM_L["Holy |cffffcc00PvE|r"],       spec="holy pve",   wowSpec="Holy Priest", icon="Interface\\Icons\\Spell_Holy_GuardianSpirit"   },
    { label=PBM_L["Shadow |cffffcc00PvE|r"],     spec="shadow pve", wowSpec="Shadow",      icon="Interface\\Icons\\Spell_Shadow_ShadowWordPain" },
    { label=PBM_L["Discipline |cffff4444PvP|r"], spec="disc pvp",   wowSpec="Discipline",  icon="Interface\\Icons\\Spell_Holy_WordFortitude"    },
    { label=PBM_L["Holy |cffff4444PvP|r"],       spec="holy pvp",   wowSpec="Holy Priest", icon="Interface\\Icons\\Spell_Holy_GuardianSpirit"   },
    { label=PBM_L["Shadow |cffff4444PvP|r"],     spec="shadow pvp", wowSpec="Shadow",      icon="Interface\\Icons\\Spell_Shadow_ShadowWordPain" },
}
...
function PBM.OpenPriestMenu(row)
    if not LichbornePriestMenu then
        ...
        healingSpecLabel:SetText(PBM_L["Healing"])
        ...
        dpsSpecLabel:SetText(PBM_L["DPS"])
        ...
        treeHealBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetText(PBM_L["|cffffcc00Heal|r |cff999999- |r|cffFFFFFFheal|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Discipline healing|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Holy Heal, Holy DPS, Shadow.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeHolyHealBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Holy Heal|r |cff999999- |r|cffFFFFFFholy heal|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Holy healing specialization|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Discipline, Holy DPS, Shadow.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeHolyDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Holy DPS|r |cff999999- |r|cffFFFFFFholy|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Holy DPS specialization|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Discipline, Holy Heal, Shadow.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeShadowDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Shadow|r |cff999999- |r|cffFFFFFFshadow|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Shadow DPS specialization|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFF4444Mutually exclusive with Discipline, Holy Heal, Holy DPS.|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeHealerDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Healer DPS|r |cff999999- |r|cffFFFFFFhealer dps|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Healer that fills with DPS|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Priest heals when needed, then fills with"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFFFFFFShadow Word: Pain|r and |cffFFFFFFMind Blast|r between heals."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00DPS AoE|r |cff999999- |r|cffFFFFFFshadow aoe|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00AoE shadow rotation|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeShadowAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Shadow AoE|r |cff999999- |r|cffFFFFFFshadow aoe|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Shadow AoE rotation|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        debuffLabel:SetText(PBM_L["Debuff"])
        ...
        treeDpsDebuffBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00DPS Debuff|r |cff999999- |r|cffFFFFFFshadow debuff|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Target debuff rotation|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeShadowDebuffBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Shadow Debuff|r |cff999999- |r|cffFFFFFFshadow debuff|r |cffee4433CO|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Shadow debuff rotation|r"], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        assistLabel:SetText(PBM_L["Assist"])
        ...
        treeSideBuffBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine(PBM_L["|cffffcc00Group stat buffs|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFFFFFFPower Word: Fortitude, Divine Spirit,|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["|cffFFFFFFShadow Protection|r."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeSideResBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:SetFrameLevel(LichbornePriestMenu:GetFrameLevel() + 20)
            GameTooltip:ClearLines()
            GameTooltip:SetText(PBM_L["|cffffcc00Shadow Resistance|r |cff999999- |r|cffFFFFFFrshadow|r |cffee4433NC|r"])
            GameTooltip:AddLine(PBM_L["|cffffcc00Shadow resistance buff|r"], 1, 1, 1)
            GameTooltip:AddLine(PBM_L["Applies |cffFFFFFFShadow Protection|r to the group."], 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeCCBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine(PBM_L["Shackles (|cffFFFFFFShackle Undead|r) undead targets in combat."], 1, 1, 1)
