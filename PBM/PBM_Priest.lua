...
function PBM.OpenPriestMenu(row)
    if not LichbornePriestMenu then
        ...
        treeHealBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffFFFFFFPower Word: Shield, Penance, Prayer of Mending,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFFlash Heal, Divine Hymn, Renew, Pain Suppression.|r", 1, 1, 1)
        ...
        treeHolyHealBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffFFFFFFCircle of Healing, Divine Hymn, Guardian Spirit,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFPrayer of Mending, Prayer of Healing,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFGreater Heal, Flash Heal, Renew.|r", 1, 1, 1)
        ...
        treeHolyDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffffcc00Heal|r: |cffFFFFFFPower Word: Shield, Penance, Prayer of Mending,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFFlash Heal, Divine Hymn, Renew, Pain Suppression.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00DPS|r: |cffFFFFFFHoly Fire, Smite, Mana Burn, Starshards.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFShadowfiend|r on medium mana. |cffFFFFFFMana Burn|r on low mana.", 1, 1, 1)
        ...
        treeShadowDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Enters |cffffcc00Shadowform|r and maintains |cffffcc00DoTs|r:", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFShadow Word: Pain, Mind Flay, Mind Blast,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFVampiric Touch, Devouring Plague.|r", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00Vampiric Embrace|r procs healing on damage dealt.", 1, 1, 1)
        ...
        treeHealerDpsBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffffcc00AoE:|r |cffFFFFFFMind Sear|r on demand.", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("|cffFFFFFFShadow Word: Pain, Vampiric Touch|r on attackers.", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFMind Sear|r channels when 3+ enemies cluster.", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeShadowAoeBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Requires |cffffcc00Shadowform|r. Uses |cffFFFFFFMind Sear|r as primary", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00AoE|r. Also applies |cffFFFFFFShadow Word: Pain|r and", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFVampiric Touch|r to nearby attackers.", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        treeDpsDebuffBtn:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Applies |cffFFFFFFVampiric Touch, Devouring Plague,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFFFFFShadow Word: Pain.|r", 1, 1, 1)
            GameTooltip:Show()
        end)
        ...
        do
            ...
            IconOff(treeSideBuffBtn); IconOff(treeSideResBtn)
            ...
            LichbornePriestMenu.resetAllIcons = function()
                ...
                IconOff(treeDpsAoeBtn); IconOff(treeShadowAoeBtn)
                IconOff(treeDpsDebuffBtn); IconOff(treeShadowDebuffBtn)
                IconOff(treeSideBuffBtn); IconOff(treeSideResBtn); IconOff(treeTankAssistBtn)
            end
