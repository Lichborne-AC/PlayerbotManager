...
function PBM.OpenRogueMenu(row)
    if not LichborneRogueMenu then
        ...
        local treeAsBtn = MakeTreeBtn(col1X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Uses |cffFFF569Mutilate|r to build |cffffcc00combo points|r,", 1, 1, 1)
            GameTooltip:AddLine("spending with |cffFFF569Rupture|r and |cffFFF569Envenom|r.", 1, 1, 1)
            GameTooltip:AddLine("Maintains |cffFFF569Deadly Poison|r and", 1, 1, 1)
            GameTooltip:AddLine("|cffFFF569Instant Poison|r. Manages |cffffcc00Energy|r", 1, 1, 1)
            GameTooltip:AddLine("and |cffffcc00DoTs|r throughout the fight.", 1, 1, 1)
        ...
        local treeCombatBtn = MakeTreeBtn(col2X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Uses |cffFFF569Sinister Strike|r to build", 1, 1, 1)
            GameTooltip:AddLine("|cffffcc00combo points|r. Maintains |cffffcc00Slice and Dice|r", 1, 1, 1)
            GameTooltip:AddLine("for attack speed. Spends points on", 1, 1, 1)
            GameTooltip:AddLine("|cffFFF569Eviscerate|r or |cffFFF569Rupture|r as finisher.", 1, 1, 1)
        ...
        local treeSubtletyBtn = MakeTreeBtn(col3X + ICON_OFF, specIconY,
            ...
            GameTooltip:AddLine("Opens with |cffFFF569Ambush|r or |cffFFF569Backstab|r", 1, 1, 1)
            GameTooltip:AddLine("from |cffffcc00Stealth|r. Builds |cffffcc00combo points|r", 1, 1, 1)
            GameTooltip:AddLine("with |cffFFF569Hemorrhage|r, spends on", 1, 1, 1)
            GameTooltip:AddLine("|cffFFF569Rupture|r.", 1, 1, 1)
        ...
        local treeDpsAoeBtn = MakeTreeBtn(assistHdrX + 60, assistIconY,
            ...
            GameTooltip:AddLine("Switches to |cffffcc00AoE|r attacks on multiple", 1, 1, 1)
            GameTooltip:AddLine("targets. Uses |cffFFF569Fan of Knives|r as the", 1, 1, 1)
            GameTooltip:AddLine("primary |cffffcc00AoE|r ability.", 1, 1, 1)
        end)
        ...
        local treeStealthBtn = MakeTreeBtn(combatHdrX + 30, combatIconY,
            ...
            GameTooltip:AddLine("Enters |cffffcc00Stealth|r between fights", 1, 1, 1)
            GameTooltip:AddLine("when possible. Uses |cffffcc00Stealth|r-opening", 1, 1, 1)
            GameTooltip:AddLine("rotation when engaging.", 1, 1, 1)
        end)
        ...
        local treeStealthedBtn = MakeTreeBtn(combatHdrX + 60, combatIconY,
            ...
            GameTooltip:AddLine("Opens with |cffFFF569Sap, Ambush,|r", 1, 1, 1)
            GameTooltip:AddLine("or |cffFFF569Cheap Shot|r from stealth.", 1, 1, 1)
        ...
        local treeBoostBtn = MakeTreeBtn(combatHdrX + 90, combatIconY,
            ...
            GameTooltip:AddLine("Uses all offensive cooldowns on", 1, 1, 1)
            GameTooltip:AddLine("cooldown: |cffFFF569Adrenaline Rush|r,", 1, 1, 1)
            GameTooltip:AddLine("|cffFFF569Blade Flurry, Cold Blood,|r", 1, 1, 1)
            GameTooltip:AddLine("|cffFFF569Killing Spree|r.", 1, 1, 1)
